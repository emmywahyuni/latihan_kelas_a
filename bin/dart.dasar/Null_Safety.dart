...
//Default Value
  ...
  //Pakai Default Value
  //guest = 'wahyuni'; //bakal tampil warning karena dart tau value nya sudah kita set di bagian ini String guestName = guest ?? 'akhmad';
  String guestName = guest ?? 'emmy'; // String guestName = guest ??;

  //Pakai Ternary
  //String guestName = guest != null ? guest : 'emmy';
